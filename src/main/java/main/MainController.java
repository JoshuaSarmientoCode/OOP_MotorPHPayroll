    ...
    public void handleLogin(String employeeId, String password) {
        ...
        try {
            ...
            if (success) {
                ...
                // Double-check that currentUser has employee
                if (currentUser != null && currentUser.getEmployee() == null) {
                    System.out.println("WARNING: Current user has no employee, reloading...");
                ...
                if (currentEmployee == null) {
                    ...
                    System.out.println("Employee Class: " + currentEmployee.getClass().getSimpleName());
                    System.out.println("Employee Position: " + currentEmployee.getPosition());
                    System.out.println("User Role: " + currentUser.getRole());
                    System.out.println("User Role Name: " + currentUser.getRoleName());
                    System.out.println("Employee ID from User: " + currentUser.getEmployeeId());
                    System.out.println("Employee ID from Employee: " + currentEmployee.getEmployeeId());
