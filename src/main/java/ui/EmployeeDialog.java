...
public class EmployeeDialog extends JDialog {
    ...
    private final MainController controller; // Added controller reference
    ...
    public EmployeeDialog(Frame parent, String title, Employee employee, 
        ...
        this.controller = null; // Set to null if not available
    ...
    private JPanel createFormPanel() {
        ...
        gbc.gridx = 1;
        empIdField = createTextField(15, true);
        ...
        gbc.gridx = 1;
        lastNameField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        firstNameField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        birthDateField = createTextField(15, false);
        ...
        birthDateField.addFocusListener(new ValidationFocusListener(f -> {
            try {
                ...
                setFieldError(birthDateField, "Invalid date format");
            }
        }));
        ...
        gbc.gridx = 1;
        addressField = createTextField(25, false);
        ...
        gbc.gridx = 1;
        phoneField = createTextField(15, false);
        ...
        gbc.gridx = 1;
        emailField = createTextField(25, false);
        ...
        gbc.gridx = 1;
        positionField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        supervisorField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        salaryField = createTextField(15, false);
        ...
        gbc.gridx = 1;
        sssField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        tinField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        philField = createTextField(20, false);
        ...
        gbc.gridx = 1;
        pagibigField = createTextField(20, false);
    ...
    private void setFieldError(JTextField field, String message) {
        field.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(UITheme.ACCENT_RED),
    ...
    private void loadData() {
        ...
        if (employee.getStatus() != null) {
            statusCombo.setSelectedItem(employee.getStatus().getDisplayName());
        }
