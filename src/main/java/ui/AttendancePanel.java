...
public class AttendancePanel extends JPanel {
    ...
    private void loadAttendanceData() {
        ...
        if (employeeId == null || employeeId.trim().isEmpty()) {
            controller.showError("No employee ID found for current user");
            return;
        }
        ...
        if (selectedPeriod == null) {
            ...
            periodCombo.setSelectedItem(selectedPeriod);
        }

        LocalDate startDate = selectedPeriod.atDay(1);
        LocalDate endDate = selectedPeriod.atEndOfMonth();

        System.out.println("Loading attendance for employee: " + employeeId +
    ...
    private void loadFullHistory(String employeeId, LocalDate start, LocalDate end) {
        ...
        try {
            // Get records
            List<Attendance> records = attendanceService.getAttendanceForPeriod(employeeId, start, end);
    ...
    private void loadRecentHistory(String employeeId) {
        ...
        try {
            ...
            // Get records
            List<Attendance> recentRecords = attendanceService.getAttendanceForPeriod(
    ...
    private void updateStatistics(String employeeId, YearMonth period) {
        try {
            ...
            if (summary != null) {
                ...
                presentDaysLabel.setText(String.valueOf((int) summary.getOrDefault("presentDays", 0)));
